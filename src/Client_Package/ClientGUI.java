...
class ClientGUI extends JFrame implements ActionListener {
  ...
  //  private static final JLabel welcome = new JLabel();
    ...
    private static final JButton post = new JButton("Сообщение");
    private static final JButton disconnect = new JButton("Отлючиться");
    ...
    private void showTime() {
        ...
        message.setText("Время подключения: " + dateFormat.format(cal.getTime()));
    }
    ...
    private static String getUserName(){
        String name = JOptionPane.showInputDialog( "Я "+ChatServer.getClients() + " клиент!");
